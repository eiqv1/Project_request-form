...
import "./LateRegistrationForm.css";

const LateRegistrationForm = () => {
  return (
    <>
      <div className="container">
        <h2>ใบคำร้องขอลงทะเบียนเรียนล่าช้า</h2>

        <form>
          <div className="form-head">
            <label>เรื่อง/Subject</label>
            <label>ขอลงทะเบียนเรียนล่าช้า</label>
          </div>
          ...
          <div className="flex-container">
            <div className="form-info">
              <div className="body-closing">
                มีความประสงค์ขอลงทะเบียนเรียนล่าช้า ในภาคการศึกษาที่
              </div>
            ...
            <div className="form-info">
              <label>
                และอาจารย์ประจำวิชาได้รับรองว่านักศึกษาได้เข้าศึกษาเกิน 80%
                ของเวลาเรียนทั้งหมด
              </label>
              <div>โดยมีรายวิชาที่ลงทะเบียน ดังนี้</div>
            </div>
          </div>
...
export default LateRegistrationForm;