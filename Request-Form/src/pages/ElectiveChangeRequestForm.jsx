...
import './ElectiveChangeRequestForm.css';

const ElectiveChangeRequestForm = () => {
  return (
    <>

    <div className='container'>
      <h2>ใบคำร้องขอเปลี่ยนวิชาเลือก</h2>

      <form>

        <div className='form-head'>
          <label>เรื่อง/Subject</label>
          <label>ขอเปลี่ยนวิชาเลือก</label>
        </div>
        ...
        <div className='closing'>วิชาเลือก</div>

        <div className='flex-container-course'>
          
          <div className='form-info-course'>

            <div className='closing'>1. เปลี่ยนจากวิชา</div>
            <input type="text" />
        ...
        <div className='flex-container-course'>
          ...
          <div className='form-info-course'>
            ...
            <div className='closing'>2. เปลี่ยนจากวิชา</div>
            <input type="text" />
...
export default ElectiveChangeRequestForm