...
import './UnderloadRegistrationForm.css';

const UnderloadRegistrationForm = () => {
  return (
    <>

    <div className='container'>
      <h2>ใบคำร้องขอลงทะเบียนเรียนต่ำกว่าหน่วยกิตที่กำหนด</h2>

      <form>

        <div className='form-head'>
          <label>เรื่อง/Subject</label>
          <label>ขอลงทะเบียนเรียนต่ำกว่าหน่วยกิตที่กำหนด</label>
        </div>
        ...
        <div className='flex-container'>
          ...
          <div className='form-info'>
            <div className='body-closing'>
              <label>
                มีความประสงค์ ขอลงทะเบียนเรียนต่ำกว่าหน่วยกิตที่กำหนด จำนวน <input className='short-input' type="text" />หน่วยกิต 
              </label>
            </div>
          </div>
        ...
        <div className='grid-container-checkbox'>
            ...
            <div>
              <div>
                <label><input type="checkbox" />สหกิจศึกษาหรือฝึกประสบการณ์ภาคสนาม</label>
              </div>
              ...
              <div>
                <label><input type="checkbox" />กรณีเจ็บป่วย (แนบใบรับรองแพทย์)</label>
              </div>
            ...
            <div className='condition-section'>
              <div>
                <label><input type="checkbox" />เคยลงทะเบียนเรียนต่ำกว่าหน่วยกิตที่กำหนด ในภาคการศึกษาที่</label>
                <select name="term" id="term">
                  <option value="term-1">1</option>
                  <option value="term-2">2</option>
                </select>
              ...
              <div>
                <label><input type="checkbox" />ไม่เคยลงทะเบียนเรียนต่ำกว่าหน่วยกิตที่กำหนด</label>
              </div>           
            </div>
...
export default UnderloadRegistrationForm