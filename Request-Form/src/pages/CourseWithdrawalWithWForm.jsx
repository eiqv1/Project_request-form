...
import "./CourseWithdrawalWithWForm.css";

const CourseWithdrawalWithWForm = () => {
  return (
    <>
      <div className="container">
        <h2>ใบคำร้องขอถอนรายวิชาโดยได้รับอักษร W</h2>

        <form>
          <div className="form-head">
            <label>เรื่อง/Subject</label>
            <label>ขอถอนรายวิชาโดยได้รับอักษร W</label>
          </div>
          ...
          <div className="flex-container">
            <div className="form-info">
              <div className="body-closing">
                <label>
                  มีความประสงค์ขอถอนรายวิชาโดยได้รับอักษร W ในภาคการศึกษาที่
                </label>
                <input className="short-input" type="text" />
              </div>
            </div>
